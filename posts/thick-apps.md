...
(version 15.11.2, for what it's worth). Sure you can click through the
...
travelling. UIs deal notoriously poorly with intermittent or partial
...
resource use testing. If Google didn't do all of that so well, then we
