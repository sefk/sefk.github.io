...
OK, with that out of the way, this is how to set it up yourself:
...
4. Sync your photo library.  From a shell:
...
5. It's easy enough to set up as a cron job to run weekly or so.  Me,
   ...
   backup for me -- not too much, but would break the bank if you
   did it daily.
